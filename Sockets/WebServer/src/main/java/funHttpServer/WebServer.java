				...
				if (request.length() == 0) {
					...
					if (request.contains("query")) {
						try {
							...
							if (json.indexOf("full_name") != -1 && json.indexOf("avatar_url") != -1) {
								builder.append("HTTP/1.1 200 OK\n");
								builder.append("Content-Type: text/html; charset=utf-8\n");
								builder.append("\n");
								...
								builder.append("Content-Type: text/html; charset=utf-8\n");
								builder.append("\n");
								builder.append("Parameter did not find the page needed.");
							}
						} catch (StringIndexOutOfBoundsException ex) {
							builder.append("HTTP/1.1 400 Invalid Syntax\n");
							builder.append("Content-Type: text/html; charset=utf-8\n");
							builder.append("\n");
							builder.append("Parameter does not have anything.");
						} 
					} else {
						builder.append("HTTP/1.1 400 Invalid Syntax\n");
						builder.append("Content-Type: text/html; charset=utf-8\n");
